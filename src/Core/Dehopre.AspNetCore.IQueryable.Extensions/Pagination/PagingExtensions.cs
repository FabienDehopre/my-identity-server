namespace Dehopre.AspNetCore.IQueryable.Extensions.Pagination
{
    using System;
    using System.Linq;
    ...
    {
        public static IQueryable<TEntity> Paginate<TEntity>(this IQueryable<TEntity> result, int limit = 10, int offset = 0)
        {
            if (limit <= 0)
            {
                limit = 10;
        ...
        public static IQueryable<TEntity> Paginate<TEntity, TModel>(this IQueryable<TEntity> result, TModel options) where TModel : class, IQueryPaging
        {
